...
<template>
    <section class="card" v-for="info in store.serieTrovate">
        ...
        <div class="info-serie">
            ...
            <!-- Bandiera Lingua -->
            <div v-for="lingua in lingueSerie" class="img-lingua">
            ...
            <div v-if="!lingueSerie.includes(info.original_language)" class="img-lingua">
                <span class="identificativo">
